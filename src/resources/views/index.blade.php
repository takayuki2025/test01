        ...
        <tr>
          <div class="form__group">
            ...
            <div class="form__group-content">
              ...
              <td colspan="3"><input type="email" name="email" placeholder="例：test@example.com" value="{{ old('email') }}" />
              </div>
                <div class="form__error">
                @error('email')
                    {{ $message }}
            ...
            <div class="form__group-title8">
              ...
              <td colspan="3"><div class="form__group-content">
                <div class="form__input--textarea">
                  <textarea name="detail" placeholder="例：お問い合わせ内容をご記入ください">{{ old('detail') }}</textarea>
                </div>
                  <div class="form__error">
                    @error('detail')
                    {{ $message }}
